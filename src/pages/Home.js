...
const Home = () => {
  return (
      <Grid container className='container' spacing={1} justifyContent='center' textAlign='center'  >
        ...
        <Grid xs={12}><h2 className='' style={{marginBottom: ''}}>Discover the Value of a Travel Designer</h2></Grid>
        
        <Grid xs={12} md={6} >
        
          <h3 className='' style={{fontWeight: 'bolder', color: 'black', fontSize: '30px'}}>Customized Service</h3>
          <p 
            style={{margin: '18px', fontWeight: 'bold', fontSize: '20px', textAlign: 'left'}}>
